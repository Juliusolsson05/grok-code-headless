...
leader, native stdio control client and real TUI attached to the same session.
Inference and MCP are loopback fixtures; no TUI keystrokes/pastes, real auth,
personal config or OS clipboard mutation are used.
